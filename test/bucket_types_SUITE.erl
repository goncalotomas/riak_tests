...
-export([
    default_bucket_type_test/1
    ,custom_bucket_type_test/1
    ,utf8_test/1
    ,bucket_properties_test/1
...
all() ->
    [
        default_bucket_type_test
        ,custom_bucket_type_test
        ,utf8_test
        ,bucket_properties_test
        ,bucket_type_properties_test
